...
export function getRuntimeConfig(buildFlags: BuildFlags): RuntimeConfig {
  const buildPreset: Record<BuildFlags['channel'], RuntimeConfig> = {
    stable: {
      ...
      downloadUrl: process.env.DOWNLOAD_URL || 'https://affine.pro/download',
      ...
      serverUrlPrefix: process.env.SERVER_PREFIX || 'https://app.affine.pro',
      editorFlags,
    ...
    canary: {
      ...
      enablePayment: true,
      enablePageHistory: true,
      serverUrlPrefix: process.env.SERVER_PREFIX! || 'https://affine.fail',
      editorFlags,
      appVersion: packageJson.version,
      editorVersion: packageJson.dependencies['@blocksuite/presets'],
      appBuildType: 'canary',
